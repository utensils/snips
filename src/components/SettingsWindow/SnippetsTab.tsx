...
import { TrashSymbolic } from '@/components/adwaita';
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <button
          ...
          className="p-1 text-muted-foreground transition-colors hover:text-red-500 dark:hover:text-red-300"
          aria-label="Delete snippet"
        >
          <TrashSymbolic className="h-5 w-5" />
        </button>
      </div>
    </div>
  );
